        ...
        <Transition.Root show={show} as={Fragment}>
            <Dialog as="div" className="fixed z-10 inset-0 overflow-y-autogrcontactId" initialFocus={cancelButtonRef} onClose={() => closeModal()} >
                <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center content-center">
                    ...
                    >
                        <div className="inline-block w-[327px] h-[246px] align-bottom bg-[#FFFFFF] text-left  shadow-xl transform transition-all my-[6rem] m:my-[15rem] rounded-[1.875rem]">
                            {/*Header modal */}
                            ...
                            <div className="flex h-[120px] ml-[1rem] ">
                                ...
                                {/*ContencontactIdo*/}
                                <GoAlert className='h-[80px] w-[80px] text-[#E00000] self-center mr-[8px]'/>
                                <div className='font-bold leading-[19.07px] tracking-[-5%] text-[20px] self-center'>  ¿Seguro que deseas eliminar la zona?
                                </div>
                            ...
                            <div className='flex mt-[1rem]'>
                                ...
                                <button
                                    className="h-[48px] w-[136px] bg-[#F25B3D] rounded-[10px] ml-[24px] font-bold text-[16px] leading-[22px] tracking-[-1px] "
                                ...
                                <div
                                    className="flex h-[48px] w-[136px] border-[2px] border-[#626262] bg-white rounded-[10px] mr-[24px] ml-[9px] font-bold text-[16px]  
                                    cursor-pointer leading-[22px] tracking-[-1px]"
                                    onClick={() => closeModal()}
                                >

                                  
                                        <div className='text-[#626262] self-center ml-[auto] mr-[auto]'>No</div>
